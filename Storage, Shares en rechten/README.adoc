...
* Je kan een shared folder opnemen in AD (toepassen)
* Je kan voor gebruikers in AD Home-folders aanmaken op een gedeelde folder met de correcte NTFS-permissies (toepassen)
* Je kan roaming profiles instellen op AD m.b.v. folder omleiding (toepassen-analyseren)
