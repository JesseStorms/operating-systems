...
Net voordat je licentie verloopt kan je wel Windows “rearmen”, wat wil zeggen dat je je evaluatieperiode verlengt. Dat kan je een aantal keer doen, totdat de evaluatieperiode verstreken is. Meer informatie over het verlengen van de licentiesleutel vind je op de https://petri.com/how-to-extend-windows-server-evaluation[Microsoft Support-website]. 
